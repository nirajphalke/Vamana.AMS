...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'master-manager',
        loadComponent: () => import('./components/master-manager/master-manager.component').then((c) => c.MasterManagerComponent)
      },
      {
        path: 'student-admission',
        loadComponent: () => import('./components/student-admission/student-admission.component').then((c) => c.StudentAdmissionComponent)
      },
      {
        path: 'receipt-type-list',
        loadComponent: () => import('./components/fees/receipt-type/receipt-type-list/receipt-type-list.component').then((c) => c.ReceiptTypeListComponent)
      }

      // components\fees\receipt-type
    ]
  },
  {
    path: '',
